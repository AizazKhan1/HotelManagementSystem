...
<body>
    ...
    <header>
        ...
        <nav>
            <div class="row">
                <img src="images/aaa.jpg" class="logo">
                <ul class="main-nav" id="check-class">
                    <li><a href="Main.php">Home</a></li>
                    <li><a href="Aboutus.html">About Us</a></li>
                    <li><a href="Form.html">Book Your Room</a></li>
                    <li><a href="login_form.php" class="admin">ADMIN LOG IN</a></li>
                </ul>
                ...
                <div class="footer-section contact-form">
                    <div class="contact">
                        <span><i class="fa fa-phone"></i> &nbsp;
                            123-456-789</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span><i class="fa fa-envelope"></i> &nbsp; info@AAAHotels.com</span>
                    </div><br>
                    <div class="socials">
                        <a href=""
                            style="color: white; text-decoration: none;" i class="fa fa-facebook"></i></a>&nbsp;&nbsp;
                        <a href="" style="color: white; text-decoration: none;" i
                            class="fa fa-instagram"></i></a>&nbsp;&nbsp;
                        <a href="" style="color: white; text-decoration: none;" i
                            class="fa fa-twitter"></i></a>&nbsp;&nbsp;
                        <a href=""
                            style="color: white; text-decoration: none;" i class="fa fa-youtube"></i></a>&nbsp;
                    </div>
                </div>

            </div>
            <div class="footer-bottom">
                &copy; AAA Hotels.com | Designed by AAA <br>
                Copyright &copy 2020 AAA  Online Private Limited, Pakistan. All rights reserved
            </div>
        </div>
